...
<body onload="precargarbanner(); Carrito();">
        ...
        <div class="columna">
            <div class="productos">
                <?php
                    ...
                    $sql = "SELECT * FROM productos WHERE status = 1 AND eliminado = 0 AND id = $producto_id";
                    $res = $con->query($sql);
                    $row = $res->fetch_array();
                        $id = $row["id"];
                        $nombre = $row["nombre"];
                        ...
                        <img class=\"imagen\" src=\"$path\" alt=\"Imagen\">
    ...
    <br>
    <div class="final"><footer class="footer">Todos los derechos reservados 2023 | Terminos y condiciones | Política de privacidad | Redes sociales</footer></div>
    <br>
